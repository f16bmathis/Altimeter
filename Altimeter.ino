...
//#define USE_BME280 1                                                   // Not using a BME so commented out
...
#include <Adafruit_Sensor.h>                                                          //added Adafruit BMP280 library and all
         ...
         //#ifdef USE_BME280                                             //Beginning of Commented all these out, dont use a BME

         //#include <Adafruit_BME280.h>                                  //Commented all these out, dont use a BME

         //Adafruit_BME280 bme ;; // I2C                                 //Commented all these out, dont use a BME

         //#else                                                         //Commented all these out, dont use a BME

  #include <Adafruit_BMP280.h>

  #include <SPI.h>                                                        // Enabled

  #define BMP_CS 19                                                       // Enabled

  Adafruit_BMP280 bmp(BMP_CS) ;; // hardware SPI                          // Enabled

  // Adafruit_BMP280 bmp ;; // I2C                                        // Disabled

         // #endif                                                       // End of the part of the commented out above
...
void setup() {
  ...
  // #ifdef USE_BME280                                                          // No BME

  // if (!bme.begin(0x76)) {                                                   //

     //Serial.println("BME init failed!");                                    // Was already commented out
  ...
  // #endif                                                                     // Part of commented out above
  ...
  if(identifier == 0x9341) {
    ...
    //tft.reset();                                                             // ***THIS IS THE ONE HAD TO COMENT OUT TO GET THE SCREEN TO WORK!
...
//    tft.setCursor(0, 290); tft.println(" mBar");
    ...
    tft.setCursor(0, 300); tft.println(" DEG F");

//#ifdef USE_BME280                                                                   // Not using BME

    //tft.setCursor(0, 310); tft.println(" Hum%");                                    // Not using BME
...
//#ifdef USE_BME280                                                        // Not using BME sensor

     //float T = bme.readTemperature();                                    //

     //float P = 0.01* bme.readPressure();                                 //

     //float H = round(3.28*bme.readAltitude(QNH)) ;                       //

     //float W = bme.readHumidity();                                       //
...
//#endif                                                                   // Also not using BME from above
...
//     tft.setCursor(40, 280); tft.println(DA, 0);                                      // Dont want DA Data

//     tft.setCursor(40, 290); tft.println(P, 2);                                       // Dont want P Data

     tft.setCursor(90, 300); tft.println(T, 1);

//#ifdef USE_BME280                                                                     // Not using BME

//     tft.setCursor(40, 310);  tft.println(W, 0);                                      // Not using BME
